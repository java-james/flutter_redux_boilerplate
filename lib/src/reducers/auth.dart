...
Reducer<AuthState> authReducer = combineReducers([
  ...
  TypedReducer<AuthState, global_actions.ResetAction>(_resetReducer),
]);
...
AuthState _resetReducer(AuthState authState, global_actions.ResetAction action) => AuthState();
